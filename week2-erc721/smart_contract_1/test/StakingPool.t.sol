...
contract StakingPoolTest is Test {
    ...
    bytes32 merkleRoot =
        0x32b4c77a35d1797955dddb132a0a83fe87d9039b971269bfe9b094131591e19d;
    ...
    function testWithdrawAllReward() public {
        ...
        vm.expectEmit(address(stakingPool));
        emit withdrawRewardToken(
            alice,
            2 * REWARD_PER_DAY * 1e18,
            block.timestamp
        );
    ...
    function testMultipleDepositAndWithdraw() public {
        ...
        assertEq(
            ...
            (1 + 3 * 2) * REWARD_PER_DAY * 1e18
        ); // 20 (from last withdraw) + 2*3*20 (2 tokens * 3 days)
