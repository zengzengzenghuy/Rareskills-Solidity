...
contract ERC777Mock is Context, IERC777, IERC20 {
    ...
    function setERC1820Registry(address erc1820Registry) public {
    ...
    function balanceOf(
        address tokenHolder
    ) public view virtual override(IERC20, IERC777) returns (uint256) {
